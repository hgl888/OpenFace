...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        rectangle (long l_, long t_, long r_, long b_)
			:l(l_), t(t_), r(r_), b(b_)
        {}

        rectangle ( unsigned long w, unsigned long h) 
			: l(0), t(0), r(static_cast<long>(w)-1), b(static_cast<long>(h)-1)
        {
...
// ----------------------------------------------------------------------------------------
    ...
    inline rectangle intersect (const rectangle& a, const rectangle& b) { return a.intersect(b); }
